				...
				<li class="button"><br />
					<form action="https://www.linkedin.com/uas/oauth2/authorization"
						...
						<input type="hidden" name="response_type" value="code" /> <input
							...
							type="image" onclick="return closeSession();"
				...
				<ul class="nav navbar-nav side-nav">
					<li>
						...
						<form id="custom-search-form"
							...
							action="/recommender/${token}/coursesearch" method="GET">
					...
					<li><a href="index.html?token=${token}"><i
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<div class="round">
								<img src="${picture}" width=100 heigth=200 />
